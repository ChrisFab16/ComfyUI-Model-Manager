...
async def recursive_search_files(directory: str, request, progress_callback: Optional[Callable[[str], Awaitable[None]]] = None):
    """
    Recursively search for files in a directory and optionally report progress.
    """
        ...
        for file_name in filenames:
            try:
                ...
                if progress_callback:
                    await progress_callback(normalized_path)
            except:
